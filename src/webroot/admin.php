...
// PHP 8.2: Call GetActiveSkin() after Config::load() to define ACTIVE_SKIN_DIR
$Core->GetActiveSkin();
...
$Authorize = Singleton::getInstance('Authorize', array(
    'enabled' => false,  // Disabled - ACL tables not populated yet
...
$component = Filter::getAlphaNumeric($Request, 'com', 'console');
