...
// echo "<p>_SBC_ROOT_: " . _SBC_ROOT_ . "</p>\n";
...
/**
 * Include the SkyBlue CMS system files
 */
...
/**
 * Define skin constants now that config is loaded
 */
...
$Authorize = Singleton::getInstance('Authorize', array(
    'enabled' => Filter::noInjection($_GET, 'com') == 'login' ? false : true,
...
$component = Filter::getAlphaNumeric($Request, 'com', 'page');
...
echo "\n<!-- <a href='https://sketchandbuild.com'>SkyBlue CMS</a> (" . Timer::elapsed('frontend.load') . " seconds) -->" ;
