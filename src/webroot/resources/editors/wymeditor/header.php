...
$csspath = defined('ACTIVE_SKIN_DIR') ? ACTIVE_SKIN_DIR : '';

$cssname = defined('ACTIVE_SKIN_DIR') ? basename(ACTIVE_SKIN_DIR) : '';

$styleSheetPath = defined('ACTIVE_SKIN_DIR') ? ACTIVE_SKIN_DIR . "css/{$cssname}.css" : '';
