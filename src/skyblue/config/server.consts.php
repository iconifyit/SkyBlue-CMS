...
# ###################################################################################
# SITE tells SkyBlue CMS where to find the user data.
# ###################################################################################
...
# all SkyBlue CMS managers. If the number of items exceeds this limit, 
...
# of SkyBlue CMS managers. This prevents each item from breaking over two 
...
sb_conf('SB_PROD_NAME',    '&copy; 2010 Scott Lewis. SkyBlue CMS');
...
# every SkyBlue CMS site if the SkyBlue CMS page changes on the
# Bright-Crayon site. To automatically include this link on a site, simply
# place the token {skyblue:link} anywhere in your skin.
# ###################################################################################

sb_conf('SKYBLUE_INFO_LINK', '<a href="https://sketchandbuild.com">SkyBlue CMS</a>');
...
# in SkyBlue CMS are for MacOS X 10.4 (Panther), which is based on FreeBSD.
# ###################################################################################
