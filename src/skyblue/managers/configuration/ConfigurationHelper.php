...
class ConfigurationHelper {
    ...
    static function initialize() {
        // Load SqliteDAO first if needed
        ...
        // Load Controller base class first if not loaded
        if (!class_exists('Controller') && file_exists(_SBC_SYS_ . "includes/mvc/Controller.php")) {
            require_once(_SBC_SYS_ . "includes/mvc/Controller.php");
        }
        $controller_file = SB_MANAGERS_DIR . "configuration/ConfigurationController.php";
    ...
    static function getLanguageSelector($selectedOption) {
    ...
    static function getEditorSelector($selectedOption) {
    ...
    static function getUiThemeSelector($selectedOption) {
