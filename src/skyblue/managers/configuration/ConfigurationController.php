...
class ConfigurationController extends Controller {
    ...
    function doEdit($Request) {
        ...
        // Configuration is a singleton - no need for checkout
        $this->view->setData($Bean);
    }
    
    function doCancel($redirect = null) {
        // Configuration is a singleton - no need for checkin
        parent::doCancel("admin.php?com=settings");
    }
    
    /* Configuration cannot be deleted */
    function doDelete($Request, $redirect) { return false; }

    function doSave($Request, $redirect = "admin.php?com=configuration") {
