...
class LoginController extends Controller {
    ...
    function __construct($Request) {
        ...
        $this->setHandler('index',           'doIndex',            false);
        $this->setHandler('lost_password',   'doLostPassword',     false);
        $this->setHandler('reset_password',  'doResetPassword',    false);
        $this->setHandler('update_password', 'doUpdatePassword',   false);
        $this->setHandler('retrieve',        'doRetrievePassword', false);
        $this->setHandler('login',           'doLogin',            false);
        $this->setHandler('logout',          'doLogout',           true);
        $this->setHandler('cancel',          'doCancel',           false);
