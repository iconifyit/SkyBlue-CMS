...
<h1 class="h3 mb-3">
    ...
    <span class="text-muted">/</span>
    <a href="admin.php?com=menus" class="text-muted text-decoration-none"><?php __('COM.MENUS', 'Menus'); ?></a>
    <span class="text-muted">/</span>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php echo $Item->getTitle() ?: __('MENUS.NEW', 'New Menu', 1); ?></h5>
        <div>
    ...
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="id" class="form-label"><?php __('MENUS.ID', 'Item ID'); ?></label>
            ...
            <div class="col-md-8">
                <label for="title" class="form-label"><?php __('MENUS.TITLE', 'Title'); ?></label>
                <input class="form-control" type="text" name="title" value="<?php echo $Item->getTitle(); ?>" id="title" />
            </div>
        </div>
