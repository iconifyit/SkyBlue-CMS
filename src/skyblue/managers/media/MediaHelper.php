...
class MediaHelper {
    ...
    static function getItemFolder($folder) {
        return Utils::checkTrailingSlash(str_replace(SB_MEDIA_DIR, '', $folder));
    }
    
    static function fiterBySubDir($subDir, $files) {
        $filtered = array();
    ...
    static function getActionOverrideSelector($selected='rename') {
        $options = array();
    ...
    static function getFolderSelector($selected=null, $Bean) {
    ...
    static function mediaType($file) {
    ...
    static function scaleHeight($file, $ratio) {
    ...
    static function scaleWidth($file, $ratio) {
        $dims = MediaHelper::getDims($file);
        if (count($dims)) {
    ...
    static function getDims($file, $refresh) {
        static $dims;
