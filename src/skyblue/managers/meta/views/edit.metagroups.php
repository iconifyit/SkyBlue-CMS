...
<h1 class="h3 mb-3">
    ...
    <span class="text-muted">/</span>
    <a href="admin.php?com=meta&action=listgroups" class="text-muted text-decoration-none"><?php __('COM.META.GROUPS', 'Meta Groups'); ?></a>
    <span class="text-muted">/</span>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php echo $Item->getName() ?: __('META.NEW_GROUP', 'New Group', 1); ?></h5>
        <div>
            <?php HtmlUtils::mgrButton('BTN.CANCEL', 'cancelgroup', array('class' => 'btn btn-outline-secondary me-2')); ?>
            <?php HtmlUtils::mgrButton('BTN.SAVE', 'savegroup', array('class' => 'btn btn-success')); ?>
        </div>
    </div>
    <div class="card-body">
        <div class="row mb-3">
