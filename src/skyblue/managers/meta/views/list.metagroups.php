...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php __('COM.META.GROUPS', 'Meta Data Groups'); ?></h5>
        <div>
            <?php HtmlUtils::mgrActionLink('META.BTN.VIEWITEMS', 'admin.php?com=meta', array('class' => 'btn btn-outline-secondary me-2')); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <?php else : ?>
                    ...
                    <tr>
                        <td>
                            <a href="admin.php?com=meta&action=editgroup&id=<?php echo $item->getId(); ?>">
