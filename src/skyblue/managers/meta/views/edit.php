...
<h1 class="h3 mb-3">
    ...
    <span class="text-muted">/</span>
    <a href="admin.php?com=meta" class="text-muted text-decoration-none"><?php __('COM.META', 'Meta'); ?></a>
    <span class="text-muted">/</span>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php echo $Item->getName() ?: __('META.NEW', 'New Meta Tag', 1); ?></h5>
        <div>
    ...
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="id" class="form-label"><?php __('META.ID', 'Item ID'); ?></label>
            ...
            <div class="col-md-8">
                <label for="name" class="form-label"><?php __('META.NAME', 'Name'); ?></label>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <label for="content" class="form-label"><?php __('META.CONTENT', 'Content'); ?></label>
                <textarea class="form-control" name="content" id="content" rows="4"><?php echo $Item->getContent(); ?></textarea>
            </div>
        </div>

        <div class="row mb-3">
            <div class="col-md-6">
                <label class="form-label"><?php __('META.GROUPS', 'Groups'); ?></label>
                <div class="border rounded p-3">
                    <?php $count = count($groups); ?>
                    <?php for ($i=0; $i<$count; $i++) : ?>
                    <?php $checked = MetaHelper::hasGroup($Item, $groups[$i]) ? " checked" : "" ; ?>
