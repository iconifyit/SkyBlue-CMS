...
class UsersController extends Controller {
    ...
    function doCancelGroup($redirect = null) {
        // Get Request object from controller
        $Request = $this->request;
        $itemId = $Request->get('id');
        if (! is_null($itemId)) {
    ...
    function doSave($Request, $redirect = "admin.php?com=users") {
    ...
    function doDelete($Request, $redirect = "admin.php?com=users") {
    ...
    function doDeleteGroup(&$Request, $redirect = "admin.php?com=users&action=listgroups") {
