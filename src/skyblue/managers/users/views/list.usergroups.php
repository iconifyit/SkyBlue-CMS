...
<h1 class="h3 mb-3">
    ...
    <span class="text-muted">/</span>
    <?php __('COM.USERS.GROUPS', 'User Groups'); ?>
</h1>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php __('COM.USERS.GROUPS', 'User Groups'); ?></h5>
        <div>
            <?php HtmlUtils::mgrActionLink('USERS.BTN.VIEWUSERS', 'admin.php?com=users', array('class' => 'btn btn-outline-secondary me-2')); ?>
            <?php HtmlUtils::mgrActionLink('USERS.BTN.NEWGROUP', 'admin.php?com=users&action=addgroup'); ?>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <?php else : ?>
                    ...
                    <tr>
                        <td>
                            <a href="admin.php?com=users&action=editgroup&id=<?php echo $item->getId(); ?>">
                        ...
                        <td>
                            ...
                            <?php
                                HtmlUtils::mgrTask(
                                    ...
                                    'closethick',
                                    array(
                                        'onclick' => "confirm_delete(event, '{$item->getName()}', true, 'admin.php?com=users&action=deletegroup&id={$item->getId()}');",
            ...
            <ul class="pagination mb-0 justify-content-end">
                <?php for ($n=1; $n<=$pageCount; $n++) : ?>
                    <li class="page-item<?php echo ($pageNum == $n) ? ' active' : ''; ?>">
                        <a class="page-link" href="admin.php?com=users&action=listgroups&pageNum=<?php echo $n; ?>">
                            <?php echo $n; ?>
                        </a>
                    </li>
                <?php endfor; ?>
