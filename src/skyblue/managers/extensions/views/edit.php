...
<div class="jquery_tab">
    <div class="content">
        ...
        <div class="ui-widget" id="action-result">
            <div class="ui-corner-all ui-state-highlight" style="margin: 20px 0px; padding: 15px;">
                <p style="padding: 0px;">
                    <span class="ui-icon ui-icon-info" style="float: left; margin: 2px 8px 0px 0px;"></span>
                    <strong>Notice</strong>
                    The skin configuration editor is not yet implemented.
                </p>
            </div>
        </div>
        <?php endif; ?>
