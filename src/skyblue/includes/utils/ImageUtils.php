...
class ImageUtils {
    ...
    public static function imageDimsToMaxDim($dims, $maxwidth, $maxheight) {
    ...
    public static function imageDims($fp) {
        static $dims;
        static $file;
    ...
    public static function dimensions($fp) {
        static $dims;
        static $file;
    ...
    public static function width($fp) {
    ...
    public static function height($fp) {
