...
class MVC {
    ...
    static function getController($Request) {
    ...
    static function getView($type) {
        return Utils::getObject(ucwords($type)."View");
    }

    static function loadHelperClass($className, $rootpath) {
    ...
    static function loadBeanClass($className, $rootpath) {
        $ucClassName = ucwords($className);
        if (file_exists($rootpath . "managers/{$className}/{$ucClassName}.php")) {
            Loader::load("managers.{$className}.{$ucClassName}", false, $rootpath);
        }
        else if (is_dir($rootpath . "managers/{$className}/beans")) {
            Loader::load("managers.{$className}.beans.*", false, $rootpath);
        }
    }

    static function loadControllerClass($className, $rootpath) {
    ...
    static function loadDaoClass($className, $rootpath) {
    ...
    static function loadViewClass($className, $rootpath) {
