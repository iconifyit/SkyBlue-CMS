...
class InputFilter
{
    ...
    function decode($source)
    {
        ...
        // convert decimal - use preg_replace_callback instead of /e modifier
        $source = preg_replace_callback('/&#(\d+);/m', function($matches) {
            return chr($matches[1]);
        }, $source); // decimal notation
        // convert hex - use preg_replace_callback instead of /e modifier
    ...
    function quoteSmart($source, & $connection)
    {
         ...
         * get_magic_quotes_gpc() was removed in PHP 7.4, always returns false
         */
