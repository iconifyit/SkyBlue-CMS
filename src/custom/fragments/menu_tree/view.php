...
if (! is_a($Dao, 'PageDAO')) {
    trigger_error(
        __('SYSTEM.MENUTREE.CALLBY', 'The menu_tree fragment can only be called from a PHP function call.', 1),
        E_USER_ERROR
    );
}
...
<div class="horizontal-menu">
    <?php echo $Builder->getHTML(Filter::noInjection($params, 'menu'), $params); ?>
</div>
