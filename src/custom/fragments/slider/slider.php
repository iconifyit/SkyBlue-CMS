...
class SliderFragment {
    static function blurb($themeName) {
    ?>
        Your purchase of this theme at <a href="http://themeforest.net?ref=skybluecanvas" title="[[page.name]], <?php echo $themeName; ?>" class="inquire">ThemeForest.net</a> will help cover what it costs me to provide SkyBlue CMS for free.
    <?php
    }
    static function title($href, $title, $text) {
    ?>
    <a href="<?php echo $href; ?>" title="<?php echo $title; ?>" class="trackable"><?php echo $text; ?></a>
    <?php
    }
    static function thumbnail($href, $title, $image) {
    ?>
