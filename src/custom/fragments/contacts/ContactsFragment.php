...
class ContactsFragment extends Fragment {
    ...
    static function the_contact($contacts) {
        global $Core;
    ...
    static function the_form_action() {
        global $Router;
        return $Router->GetLink(Filter::get($_GET, 'pid', DEFAULT_PAGE));
    }
    
    static function the_message() {
    ...
    static function get_message_string($message) {
        return 
    ...
    static function the_action() {
        return strtolower(Filter::get($_POST, 'contacts_action', ''));
    }
    
    static function set_message($class, $title, $string) {
    ...
    static function handle_contact_form($mailto, $defaults=array()) {
        global $Core;
        global $Router;
