...
<h1 class="h3 mb-3">
    ...
    <span class="text-muted">/</span>
    <a href="admin.php?com=links&action=listgroups" class="text-muted text-decoration-none"><?php __('COM.LINKS.GROUPS', 'Links Groups'); ?></a>
    <span class="text-muted">/</span>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php echo $Item->getName() ?: __('LINKS.NEW_GROUP', 'New Group', 1); ?></h5>
        <div>
