...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php __('COM.LINKS', 'Links'); ?></h5>
        <div>
            <?php HtmlUtils::mgrActionLink('LINKS.BTN.VIEWGROUPS', 'admin.php?com=links&action=listgroups', array('class' => 'btn btn-outline-secondary me-2')); ?>
            <?php HtmlUtils::mgrActionLink('LINKS.BTN.NEW', 'admin.php?com=links&action=add'); ?>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <?php else : ?>
                    ...
                    <tr>
                        <td>
                            <a href="admin.php?com=links&action=edit&id=<?php echo $item->getId(); ?>">
            ...
            <ul class="pagination mb-0 justify-content-end">
                <?php for ($n=1; $n<=$pageCount; $n++) : ?>
                    <li class="page-item<?php echo ($pageNum == $n) ? ' active' : ''; ?>">
                        <a class="page-link" href="admin.php?com=links&action=list&pageNum=<?php echo $n; ?>">
                            <?php echo $n; ?>
                        </a>
                    </li>
                <?php endfor; ?>
