...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php __('COM.MYVARS', 'MyVars'); ?></h5>
        <div>
            <?php HtmlUtils::mgrActionLink('MYVARS.BTN.NEW', 'admin.php?com=myvars&action=add'); ?>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <?php else : ?>
                    ...
                    <tr>
                        <td>
                            <a href="admin.php?com=myvars&action=edit&id=<?php echo $item->getId(); ?>">
