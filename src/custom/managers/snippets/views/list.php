...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?php __('COM.SNIPPETS', 'Snippets'); ?></h5>
        <div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <?php else : ?>
                    ...
                    <tr>
                        <td>
                            <a href="admin.php?com=snippets&action=edit&id=<?php echo $item->getId(); ?>">
            ...
            <ul class="pagination mb-0 justify-content-end">
                <?php for ($n=1; $n<=$pageCount; $n++) : ?>
                    <li class="page-item<?php echo ($pageNum == $n) ? ' active' : ''; ?>">
                        <a class="page-link" href="admin.php?com=snippets&action=list&pageNum=<?php echo $n; ?>">
                            <?php echo $n; ?>
                        </a>
                    </li>
                <?php endfor; ?>
