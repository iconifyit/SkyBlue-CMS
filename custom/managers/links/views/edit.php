...
<div class="jquery_tab">
    <div class="content">
        <h2>
            <a href="admin.php?com=links"><?php __('COM.LINKS', 'Links'); ?></a> / 
        ...
        <div id="tabs">
            ...
            <div class="tab-body" id="tab-one">
                <fieldset class="three-column">
                    ...
                    <div class="column">
                        <label for="url"><?php __('LINKS.URL', 'URL'); ?>:</label>
                        <input class="input-medium" type="text" name="url" value="<?php echo $Item->getUrl(); ?>" id="url" />
                    </div>
                    <div class="clear"></div>
                </fieldset>
                <fieldset class="three-column last">
                    <div class="column">
                        <label for="groups"><?php __('LINKS.GROUPS', 'Groups'); ?>:</label>
                        <ul>
                            <?php $count = count($groups); ?>
                            <?php for ($i=0; $i<$count; $i++) : ?>
                            <?php $checked = LinksHelper::hasGroup($Item, $groups[$i]) ? " checked=\"checked\"" : "" ; ?>
                            <li>
                    ...
                    <div class="column">
                        <label for="relationship"><?php __('LINKS.REL', 'Relationship'); ?>:</label>
