...
<div class="jquery_tab">
    <div class="content">
        ...
        <p class="buttons-top">
            <?php HtmlUtils::mgrActionLink('LINKS.BTN.VIEWITEMS', 'admin.php?com=links'); ?>  
                        ...
                        <td colspan="4" align="right">
                            <ul class="pagination">
                                <?php for ($n=1; $n<=$pageCount; $n++) : ?>
                                    ...
                                    <li class="ui-state-default ui-corner-all<?php echo $active; ?>"><a href="admin.php?com=links&action=listgrous&pageNum=<?php echo $n; ?>"><?php echo $n; ?></a></li>
                                <?php endfor; ?>
                            </ul>
                        </td>
                    </tr>
