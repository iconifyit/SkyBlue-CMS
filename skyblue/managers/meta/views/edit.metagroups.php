...
<div class="jquery_tab">
    <div class="content">
        <h2>
            <a href="admin.php?com=links&action=listgroups"><?php __('COM.MEATA.GROUPS', 'Meta Groups'); ?></a> / 
        ...
        <p class="buttons-top">
            <?php HtmlUtils::mgrButton('BTN.CANCEL', 'cancelgroup'); ?>
            <?php HtmlUtils::mgrButton('BTN.SAVE', 'savegroup'); ?>
        </p>
