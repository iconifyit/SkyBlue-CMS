...
<script type="text/javascript" src="<?php echo SB_UI_DIR; ?>js/jquery.url/jquery.url.packed.js"></script>

<script type="text/javascript" src="<?php echo SB_UI_DIR; ?>js/actions.js"></script>

<script type="text/javascript" src="<?php echo SB_UI_DIR; ?>js/jsTree.v.1.0rc2/jquery.jstree.js"></script>
<script type="text/javascript" src="<?php echo SB_UI_DIR; ?>js/jquery.base64.js"></script>
